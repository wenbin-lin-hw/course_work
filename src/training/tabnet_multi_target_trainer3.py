...
class TabNetMultiTargetTrainer:
    def __init__(self, data_path, n_folds=5, balancing=0):
...
def main():
    ...
    # Create predictor
    predictor = TabNetMultiTargetTrainer('../../data/appendicitis/processed_appendicitis_data_final.xlsx',n_folds=5, balancing=1)
