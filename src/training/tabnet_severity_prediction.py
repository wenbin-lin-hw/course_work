...
class DiagnosisPredictor:
    def __init__(self, data_path):
        ...
        self.exclude_columns = ['Management', 'Diagnosis']
    ...
    def visualize_feature_importance(self, feature_importances_list, feature_names, fold_results):
        ...
        plt.tight_layout()
        plt.savefig('tabnet_severity_prediction_results.png', dpi=300, bbox_inches='tight')
        plt.show()

        print("✓ Visualization saved as: tabnet_severity_prediction_results.png")
    ...
    def run_complete_experiment(self):
        ...
        print(f"Results saved to: tabnet_severity_results.csv")
