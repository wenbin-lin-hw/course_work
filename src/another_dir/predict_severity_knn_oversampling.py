...
def evaluate_model(model, X_train_scaled, X_test_scaled, y_train, y_test):
    ...
    plt.tight_layout()
    plt.savefig('../../results/confusion_matrix_knn_oversampling.png', dpi=300, bbox_inches='tight')
    ...
    if len(np.unique(y_test)) == 2:
        ...
        plt.tight_layout()
        plt.savefig('../../results/roc_curve_knn_oversampling.png', dpi=300, bbox_inches='tight')
        print("ROC curve saved as 'results/roc_curve_knn_oversampling.png'")
        plt.close()
...
def plot_class_distribution(y_original, y_resampled, y_test):
    ...
    plt.tight_layout()
    plt.savefig('../../output/class_distribution_knn_oversampling.png', dpi=300, bbox_inches='tight')
...
def plot_k_vs_accuracy(X_train, X_test, y_train, y_test, k_range=range(1, 31)):
    ...
    plt.grid(True, alpha=0.3)
    plt.tight_layout()
    plt.savefig('../../results/knn_k_vs_accuracy_oversampling.png', dpi=300, bbox_inches='tight')
    print("K vs Accuracy plot saved as 'results/knn_k_vs_accuracy_oversampling.png'")
    plt.close()
...
def compare_methods(X_train, X_test, y_train, y_test, scaler):
    ...
    plt.tight_layout()
    plt.savefig('../../results/oversampling_methods_comparison_knn.png', dpi=300, bbox_inches='tight')
    print("\nComparison plot saved as 'results/oversampling_methods_comparison_knn.png'")
    plt.close()
